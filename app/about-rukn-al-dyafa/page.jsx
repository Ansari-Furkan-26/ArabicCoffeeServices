...
// Fteching language from Local Storage 
// "use client";
...
//       header: "التقط اللحظة",
//       paragraph:
//         "نحن نحتفظ بأغلى لحظاتك، في كل مناسبة على حدة. دعنا نجعل احتفالاتك حية مع خدمة تقديم الطعام الفاخرة والاهتمام بالتفاصيل.",
//     },
//   };
...
//             {translations[language].header}
//           </h2>
//           <p className="text-lg">{translations[language].paragraph}</p>
//         </div>
//       </section>
