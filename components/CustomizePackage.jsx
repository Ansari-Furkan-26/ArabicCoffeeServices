...
const translations = {
  ...
  const calculateTotal = () => {
    ...
    // Calculate the servant cost
    const servantCost = (maleServants + femaleServants) * pricePerServant;
  
    // Combine all the costs
    return (selectedPackagePrice || 0) + drinksTotal + foodTotal + deliveryCharge + servantCost;
  };
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4 flex items-center justify-center" id="cart">
      ...
      <img 
        src="https://i.pinimg.com/736x/62/a9/4a/62a94a178264ef5a926f73a72401c912.jpg" 
        alt="Package Image" 
      ...
      <div className="mb-6">
       ...
       {/* Servant Selection */}
       <h2 className="text-left  font-semibold mb-4">Servant Selection</h2>
      <div className="md:flex justify-between items-center mb-4">
        <div className="flex flex-col">
          <label htmlFor="maleServants" className="mb-2">Male Servants</label>
          <input
            type="number"
            id="maleServants"
            value={maleServants}
        ...
        <div className="flex flex-col">
          <label htmlFor="femaleServants" className="mb-2">Female Servants</label>
          <input
            type="number"
            id="femaleServants"
